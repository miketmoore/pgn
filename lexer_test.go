...
func TestTokenize(t *testing.T) {
	data := []struct {
		...
		{
			name: "Disambiguation - Originating File of Moving Piece - White",
			in:   "10. Nbd7 d4",
			out: []pgn.Token{
				pgn.Token{Type: pgn.MoveNumber, Value: "10"},
				pgn.Token{Type: pgn.Piece, Value: "N"},
				pgn.Token{Type: pgn.File, Value: "b"},
				pgn.Token{Type: pgn.File, Value: "d"},
				pgn.Token{Type: pgn.Rank, Value: "7"},
				pgn.Token{Type: pgn.File, Value: "d"},
				pgn.Token{Type: pgn.Rank, Value: "4"},
			},
		...
		{
			name: "Disambiguation - Originating File of Moving Piece - Black",
			in:   "10. d4 Nbd7",
			out: []pgn.Token{
				pgn.Token{Type: pgn.MoveNumber, Value: "10"},
				pgn.Token{Type: pgn.File, Value: "d"},
		...
		},
		{
			...
			out: buildTokens(
				...
				newMove("11", "", "c4", "", "c6"),
				[]pgn.Token{
					pgn.Token{Type: pgn.MoveNumber, Value: "12"},
					pgn.Token{Type: pgn.File, Value: "c"},
					pgn.Token{Type: pgn.Capture, Value: "x"},
					pgn.Token{Type: pgn.File, Value: "b"},
					pgn.Token{Type: pgn.Rank, Value: "5"},
