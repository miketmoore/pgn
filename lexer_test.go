...
func TestTokenize(t *testing.T) {
	data := []struct {
	...
	}{
		{
			...
			out: []pgn.Token{
				pgn.Token{Type: pgn.TokenTagPairOpen, Value: "["},
				pgn.Token{Type: pgn.TokenTagName, Value: "Event"},
				pgn.Token{Type: pgn.TokenString, Value: "F/S Return Match"},
				pgn.Token{Type: pgn.TokenTagPairClose, Value: "]"},
			},
		},
		{
		...
		},
		{
			...
			out: []pgn.Token{
				...
				pgn.Token{Type: pgn.TokenString, Value: "Belgrade, Serbia JUG"},
				pgn.Token{Type: pgn.TokenTagPairClose, Value: "]"},
				pgn.Token{Type: pgn.TokenTagPairOpen, Value: "["},
				pgn.Token{Type: pgn.TokenTagName, Value: "Date"},
				pgn.Token{Type: pgn.TokenString, Value: "1992.11.04"},
				pgn.Token{Type: pgn.TokenTagPairClose, Value: "]"},
				pgn.Token{Type: pgn.TokenTagPairOpen, Value: "["},
				pgn.Token{Type: pgn.TokenTagName, Value: "Round"},
				pgn.Token{Type: pgn.TokenString, Value: "29"},
				pgn.Token{Type: pgn.TokenTagPairClose, Value: "]"},
				pgn.Token{Type: pgn.TokenTagPairOpen, Value: "["},
				pgn.Token{Type: pgn.TokenTagName, Value: "White"},
				pgn.Token{Type: pgn.TokenString, Value: "Fischer, Robert J."},
				pgn.Token{Type: pgn.TokenTagPairClose, Value: "]"},
				pgn.Token{Type: pgn.TokenTagPairOpen, Value: "["},
				pgn.Token{Type: pgn.TokenTagName, Value: "Black"},
				pgn.Token{Type: pgn.TokenString, Value: "Spassky, Boris V."},
				pgn.Token{Type: pgn.TokenTagPairClose, Value: "]"},
				pgn.Token{Type: pgn.TokenTagPairOpen, Value: "["},
				pgn.Token{Type: pgn.TokenTagName, Value: "Result"},
				pgn.Token{Type: pgn.TokenString, Value: "1/2-1/2"},
				pgn.Token{Type: pgn.TokenTagPairClose, Value: "]"},
				pgn.Token{Type: pgn.TokenTagPairOpen, Value: "["},
				pgn.Token{Type: pgn.TokenTagName, Value: "a"},
				pgn.Token{Type: pgn.TokenString, Value: ""},
				pgn.Token{Type: pgn.TokenTagPairClose, Value: "]"},
				pgn.Token{Type: pgn.TokenTagPairOpen, Value: "["},
				pgn.Token{Type: pgn.TokenTagName, Value: "A"},
				pgn.Token{Type: pgn.TokenString, Value: ""},
